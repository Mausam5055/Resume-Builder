...
const JamieTemplate = () => {
  ...
  return (
    <div className={`w-full ${isMobile ? 'overflow-x-auto' : ''} print:overflow-x-auto print:w-full`}>
      <motion.div 
        className="bg-white shadow-lg print:shadow-none print:w-full print:min-h-auto"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="flex print:w-full print:h-full">
          {/* Left Sidebar */}
          <div className="w-[75mm] bg-slate-50 min-h-full p-6 print:p-6 print:w-[75mm] print:flex-shrink-0">
            {/* Profile Photo */}
          ...
          {/* Main Content */}
          <div className="flex-1 bg-white print:w-[calc(100%-75mm)] print:flex-shrink-0">
            {/* Header */}
