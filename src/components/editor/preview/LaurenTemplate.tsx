      ...
      <div className="flex h-full">
        ...
        <div className="w-2/5 bg-[hsl(var(--lauren-bg))] p-10 flex flex-col">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold mt-2 text-[hsl(var(--lauren-text))]">{personal.fullName}</h1>
            <p className="text-[hsl(var(--lauren-accent))] font-medium">{personal.jobTitle}</p>
          </div>
            ...
            <div className="space-y-2 text-sm">
              {personal.location && (
                <div>
                  ...
                  <p className="text-[hsl(var(--lauren-text))]">{personal.location}</p>
                </div>
              )}
              ...
              {personal.phone && (
                <div>
                  ...
                  <p className="text-[hsl(var(--lauren-text))]">{personal.phone}</p>
                </div>
              )}
              ...
              {personal.email && (
                <div>
                  ...
                  <p className="text-[hsl(var(--lauren-text))]">{personal.email}</p>
                </div>
              )}
              ...
              {personal.website && (
                <div>
                  ...
                  <p className="text-[hsl(var(--lauren-text))]">{personal.website}</p>
                </div>
              )}
            </div>
          </div>
